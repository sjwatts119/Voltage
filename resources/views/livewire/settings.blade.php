<div class="container rounded-2xl max-w-6xl">

    <div class="flex flex-row">
        <div class="w-72 bg-white dark:bg-gray-800 overflow-hidden shadow-xl">
            <div class="flex flex-col items-center justify-center h-[75vh] p-8 overflow-hidden">

<div class="container rounded-2xl overflow-auto max-w-6xl h-full md:h-[40dvh] dark:bg-gray-800 bg-white">

    {{-- Starting Screen --}}
    @if($chatType == "start")
        <div class="flex flex-col md:flex-row items-center justify-center h-full space-y-4 md:space-y-0 md:space-x-4 p-6">
            <div wire:click="selectChatType('private')" class="text-gray-800 dark:text-gray-200 w-full md:min-h-52 md:w-1/2 p-6 rounded-lg cursor-pointer transition transform hover:scale-105 shadow-xl dark:bg-gray-900">
            ...
            <div wire:click="selectChatType('group')" class="text-gray-800 dark:text-gray-200 w-full md:min-h-52 md:w-1/2 p-6 rounded-lg cursor-pointer transition transform hover:scale-105 shadow-xl dark:bg-gray-900">
                <div class="flex items-center justify-center mb-5">
                    <svg xmlns="http://www.w3.org/2000/svg" fill="none" viewBox="0 0 24 24" stroke-width="1.5" stroke="currentColor" class="size-10">

<div class="flex flex-row items-center h-16 py-7 bg-white dark:bg-gray-800 w-full px-4 md:px-10">
    <div>
        <button wire:click="$dispatch('openModal', { component: 'message-attachment', arguments: { conversationId: {{ $activeConversation->id }} }})" class="flex items-center justify-center text-gray-400 hover:text-gray-600 transition">

<div class="flex flex-row items-center h-16 py-7 bg-white dark:bg-gray-800 w-full px-4 md:px-10">
    <div>
        <button class="flex items-center justify-center text-gray-400 hover:text-gray-600  transition">
    ...
    <div class="flex-grow ml-4">
        <div class="relative w-full">
            ...
            <button class="absolute flex items-center justify-center h-full w-12 right-0 top-0 text-gray-400 hover:text-gray-600 hidden sm:block transition">

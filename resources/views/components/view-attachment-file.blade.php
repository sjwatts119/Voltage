<div class="flex items-center space-x-4 p-4 rounded-lg bg-gray-100 dark:bg-gray-800">
    ...
    <div class="flex-1">
        <a href="{{ asset('storage/attachments/' . $attachment->attachment_path) }}" target="_blank" class="block text-sm text-gray-900 dark:text-gray-200 hover:text-gray-700 dark:hover:text-gray-300 truncate">

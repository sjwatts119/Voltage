<div class="lg:max-h-[75dvh] p-4 md:p-16 md:overflow-y-auto">
    <h1 class="text-3xl font-bold text-gray-800 dark:text-gray-200 mt-5 sm:mt-0 mb-5 sm:mb-10">General Settings</h1>
